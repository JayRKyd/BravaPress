          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-white p-6 rounded-xl shadow-sm mb-4">
                <Image
                  src="/images/step1-illustration.svg"
                  alt="Step 1"
                  width={200}
                  height={200}
                  className="mx-auto"
              ...
              <h3 className="text-xl font-semibold mb-2">1. Submit Your News</h3>
              <p className="text-gray-600">
                Tell us about your announcement using our simple form
              </p>
            </div>
            <div className="text-center">
              <div className="bg-white p-6 rounded-xl shadow-sm mb-4">
              ...
              <h3 className="text-xl font-semibold mb-2">2. AI Creates Your Release</h3>
              <p className="text-gray-600">
                Our AI crafts a professional press release in minutes
              </p>
            </div>
            <div className="text-center">
              <div className="bg-white p-6 rounded-xl shadow-sm mb-4">
              ...
              <h3 className="text-xl font-semibold mb-2">3. Get Published</h3>
              <p className="text-gray-600">
                Your news distributed to major media outlets
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-gray-600 text-white hover:bg-gray-800 font-semibold px-8 py-3"
              asChild
            >
              <Link href="/contact">
                Book A Demo
